...
public class InsyService {
    ...
    public InsyService(@Qualifier("oauthRestClient") RestClient oAuthRestClient,
                       ...
                       UserRepository userRepository, ItemRepository itemRepository, OrderNumberHelper orderNumberHelper) {
    ...
    public ResponseEntity<String> createOrder(Long orderId) {
        ...
        requestOrder.setOrderNumber(orderNumberHelper.generateOrderNumber(order));
