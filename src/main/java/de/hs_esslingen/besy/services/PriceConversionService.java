...
public class PriceConversionService {
    ...
    public static BigDecimal convertNetPriceToGrossPrice(BigDecimal netPrice, VatResponseDTO vatValue) {
    ...
    public static BigDecimal convertGrossPriceToNetPrice(BigDecimal grossPrice, VatResponseDTO vatValue) {
    ...
    private static BigDecimal vatToDecimal(VatResponseDTO vat) {
